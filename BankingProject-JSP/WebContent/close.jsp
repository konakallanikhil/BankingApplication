...
<fieldset>
<form id="open" action="closeCode.jsp" method="post" name="commit" onsubmit="return validation()">
<h3>CLOSE ACCOUNT</h3>
<table>
<tr>
...
function validation()
{
  let t1 = commit.useraccountnumber.value;
  let t2 = commit.accountname.value;
  let t3 = commit.password.value;

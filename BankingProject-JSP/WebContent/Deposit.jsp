...
<fieldset>
<form id="open" action="DepositCode.jsp" method="post" name="deposit" onsubmit="return validation()">
<h3>DEPOSIT FORM</h3>
<table>
<tr>
...
function validation()
{
  let t1 = deposit.useraccountnumber.value;
  let t2 = deposit.accountname.value;
  let t3 = deposit.password.value;
  let t4 = deposit.depoamount.value;

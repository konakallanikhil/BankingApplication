...
<fieldset>
<form id="open" action="balanceCode.jsp" method="post" name="balanace" onsubmit="return validation()">
...
function validation()
{
  let t1 = balanace.useraccountnumber.value;
  let t2 = balanace.accountname.value;
  let t3 = balanace.password.value;
